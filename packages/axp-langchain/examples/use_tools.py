...
from axp_langchain import AXPFindAgentsTool, AXPGetCapacityTool, AXPQuoteContractTool
...
def main() -> None:
    ...
    print(find_agents.invoke({"status": "active", "service": "research", "min_capacity": 100}))
    print(get_capacity.invoke({"agent_id": "agent_0002"}))
    print(
        quote_contract.invoke(
            {
